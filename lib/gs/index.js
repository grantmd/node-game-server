...
var GS = exports = module.exports = function GS(){
	var self = this;
	this.redis = require('../redis-client').createClient();
	...
	this.start_player_tick = function(player){
		...
		var intervalId = setInterval(function(){
			try{
				...
				console.log('Player '+player.id+' exception: '+e);
			}
		}, 1000);
		console.log('Player '+player.id+' onTick scheduled');
